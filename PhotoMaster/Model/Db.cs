...
namespace PhotoMaster.Model
{
    class Db
    {
        ...
        public Db()
        {
            ...
            Photo photo = new Photo(40, image, gpsPoint, 93, "ms-appx:///Assets/photos/040-small.jpg", "ms-appx:///Assets/photos/040-small-check.jpg");
            photos.Add(photo);
            ...
            photo = new Photo(18, image, gpsPoint, 92, "ms-appx:///Assets/photos/018-small.jpg", "ms-appx:///Assets/photos/018-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(60, image, gpsPoint, 91, "ms-appx:///Assets/photos/060-small.jpg", "ms-appx:///Assets/photos/060-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(61, image, gpsPoint, 89, "ms-appx:///Assets/photos/061-small.jpg", "ms-appx:///Assets/photos/061-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(62, image, gpsPoint, 88, "ms-appx:///Assets/photos/062-small.jpg", "ms-appx:///Assets/photos/062-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(54, image, gpsPoint, 87, "ms-appx:///Assets/photos/054-small.jpg", "ms-appx:///Assets/photos/054-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(11, image, gpsPoint, 86, "ms-appx:///Assets/photos/011-small.jpg", "ms-appx:///Assets/photos/011-small-check.jpg");
            photos.Add(photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(75, image, gpsPoint, 85, "ms-appx:///Assets/photos/075-small.jpg", "ms-appx:///Assets/photos/075-small-check.jpg");
            photos.Add(photo);
