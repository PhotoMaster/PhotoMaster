...
namespace PhotoMaster.Model
{
    class Db
    {
        ...
        public Db()
        {
            ...
            photo = new Photo(18, image, gpsPoint, 90, "ms-appx:///Assets/photos/018-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(60, image, gpsPoint, 90, "ms-appx:///Assets/photos/060-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(61, image, gpsPoint, 90, "ms-appx:///Assets/photos/061-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(62, image, gpsPoint, 90, "ms-appx:///Assets/photos/062-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(54, image, gpsPoint, 90, "ms-appx:///Assets/photos/054-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(11, image, gpsPoint, 90, "ms-appx:///Assets/photos/011-small.jpg");
            photos.Add(gpsPoint, photo);
            ...
            gpsPoint = new Geopoint(position);
            photo = new Photo(75, image, gpsPoint, 90, "ms-appx:/Assets/photos/075-small.jpg");
            photos.Add(gpsPoint, photo);
